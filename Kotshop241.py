...
async def get_http_session():
    """Безопасное получение сессии с возможностью закрытия при остановке."""
    global http_session
    ...
    try:
        ...
        if created_locally and http_session and not http_session.closed:
...
POLICY_TEXT = (
    ...
    "расцениваются как существенное нарушение договорных обязательств и могут служить основанием "
...
PRODUCT_UNAVAILABLE_TEXT = (
    ...
    "объявлю об этом в телеграм‑канале."
)
...
POPULARITY_TEXT = (
    ...
    "обратиться после создания раздела и после объявления в телеграм‑канале."
)
